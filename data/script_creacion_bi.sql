...
SELECT T.ID_DIM_TIEMPO, P.PRODUCTO_CODIGO, NULL /*RE.ID_DIM_RANGO_ETARIO*/, C.CATEGORIA_CODIGO, --COMO JOINEAS RANGO ETARIO? LA UNICA REF PUEDE SER DE CLIENTES
...
JOIN [NUEVE_Z].[VENTA] V ON (V.VENTA_ID = DV.VENTA_ID)
JOIN [NUEVE_Z].[BI_DIMENSION_TIEMPO] T ON (YEAR(V.VENTA_FECHA) = T.ANIO AND MONTH(V.VENTA_FECHA) = T.MES)
GROUP BY T.ID_DIM_TIEMPO, P.PRODUCTO_CODIGO, RE.ID_DIM_RANGO_ETARIO, C.CATEGORIA_CODIGO
ORDER BY T.ID_DIM_TIEMPO
