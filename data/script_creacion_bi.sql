...
--EL USO DEL TOP EN ALGUNAS VISTAS ES PARA AGREGAR UN ORDER BY A LA VISTA

--------1----------
GO
ALTER VIEW [NUEVE_Z].[GANANCIAS_CANAL_VENTA] (ANIO, MES, ID_CANAL_DE_VENTA, TIPO_CANAL_VENTA, GANANCIAS)
AS
SELECT TOP 100 T.ANIO, T.MES, CV.ID_DIM_CANAL_VENTA, CV.TIPO_CANAL_VENTA, SUM(HI.GANANCIAS_CANAL_VENTA)
...
ORDER BY T.ANIO, T.MES, CV.ID_DIM_CANAL_VENTA, CV.TIPO_CANAL_VENTA

--------2----------
CREATE VIEW [NUEVE_Z].[PRODUCTOS_RENTABLES] (ANIO, MES, PRODUCTO_CODIGO, PRODUCTO_NOMBRE, RENTABILIDAD_PRODUCTO_PORCENTAJE)
AS
SELECT TOP 5 T.ANIO, T.MES, P.ID_DIM_PRODUCTO, P.PRODUCTO_NOMBRE, HP.RENTABILIDAD_PRODUCTO * 100
...
GROUP BY T.ANIO, T.MES, P.ID_DIM_PRODUCTO, P.PRODUCTO_NOMBRE, HP.RENTABILIDAD_PRODUCTO
ORDER BY 5 DESC
