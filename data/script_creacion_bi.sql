...
--------HECHOS_INGRESOS----------
INSERT INTO [NUEVE_Z].[BI_HECHOS_INGRESOS] (ID_DIM_TIEMPO, ID_DIM_PRODUCTO, ID_DIM_CANAL_VENTA, ID_DIM_MEDIO_PAGO, ID_DIM_TIPO_DESCUENTO, ID_TIPO, GANANCIAS_CANAL_VENTA, TOTAL_INGRESOS_MP, TOTAL_DESCUENTOS)
...
JOIN [NUEVE_Z].[BI_DIMENSION_TIPO_DESCUENTO] DTP ON (ID_DIM_TIPO)
