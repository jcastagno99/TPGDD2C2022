...
ESTO NO ESTA FUNCIONANDO, TRAE TODO NULO, HAY ALGUNAS LOCALIDADES QUE TIENEN LOS PROVEEDORES QUE LOS CLIENTES NO*/
...
ESTO TAMPOCO ESTA TRAYENDO NADA, ES LO MISMO QUE LAS LOCALIDADES DE LOS PROVEEDORES*/
...
SELECT DISTINCT M.VENTA_MEDIO_ENVIO, M.VENTA_ENVIO_PRECIO, CP.CP_CODIGO, L.LOCALIDAD_CODIGO
FROM [gd_esquema].[Maestra] M
JOIN [NUEVE_Z].[LOCALIDAD] L
ON(L.LOCALIDAD = M.CLIENTE_LOCALIDAD)
JOIN [NUEVE_Z].[CODIGO_POSTAL] CP
ON(CP.CODIGO = M.CLIENTE_CODIGO_POSTAL)
